...
<section class="lots">
    ...
    <ul class="lots__list">
        ...
        <li class="lots__item lot">
            ...
            <div class="lot__info">
                <span class="lot__category"><?php echo filter($value['category']); ?></span>
                <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?php echo filter($value['title']); ?></a></h3>
